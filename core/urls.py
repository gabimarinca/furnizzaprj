...
from core.views import ajax_add_review, index,about,contact, product_list_view, category_list_view, category_product_list_view, vendor_detail_view, vendor_list_view, product_detail_view
